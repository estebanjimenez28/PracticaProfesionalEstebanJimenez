...
namespace PracticaProfesionalEstebanJimenez.Reportes_Consolidados
{
    public partial class Frm_Rpt_Salida_AcumuladoxProductos : Form
    {
        ...
        private void Frm_Rpt_Salida_AcumuladoxProductos_Load(object sender, EventArgs e)
        {
            ...
            this.uSP_Reporte_Salida_AcumuladoxProductoTableAdapter.Fill(this.dataSet_ReportesConsolidados.USP_Reporte_Salida_AcumuladoxProducto, Fecha_ini: Convert.ToDateTime(txt_p1.Text), Fecha_fin: Convert.ToDateTime(txt_p2.Text));
