    ...
    public class D_Almacen
    {
        ...
        public string Guardar_al(int nOpcion, E_Almacen oAl)
        {
            ...
            try
            {
                ...
                Comando.Parameters.Add("@nCodigo", SqlDbType.Int).Value = oAl.Codigo_Almacen;
                Comando.Parameters.Add("@cDescripcion", SqlDbType.VarChar).Value = oAl.Descripcion_Almacen;
        ...
        public string Eliminar_al(int Codigo_Almacen)
        {
            string Rpta = "";
            SqlConnection SqlCon = new SqlConnection();
            try
            {
                ...
                Comando.CommandType = CommandType.StoredProcedure;
                Comando.Parameters.Add("@nCodigo_Almacen", SqlDbType.Int).Value = Codigo_Almacen;
                SqlCon.Open();
